        ...
        /*$.magnificPopup.open({
            ...
            callbacks: {
                open: function () {
                    ...
                    jQuery_3_5_1(this.container).find('#idOptika').val(idOptika);
                    jQuery_3_5_1(this.container).find('#cityOptika').val(cityOptika);
                    if (document.body.clientWidth > 780) {
                        jQuery_3_5_1(this.container).find('.mfp-content').css({
                            'width': '650px',
                            'border-radius': '20px'
                        });
                    } else {
                    ...
                    jQuery_3_5_1(this.container).find('.mfp-close').addClass('new-close');
                    ga('send', 'event', 'optics_misight', 'modal_optics_open');
                    // ym(66929020, 'reachGoal', 'modal_optics_open');
                },
                close: function() {
                    jQuery_3_5_1('#modalReception').removeClass('sms sms-success sms-error sms-false');
                    console.log('%c CooperVision -> Закрыл модалку', 'color: green');
                    // console.log('%c CooperVision -> final: '+final, 'color: green');
                    // if (final === true) {
                    //     jQuery_3_5_1('#modalReception').removeClass('sms-success');
                    //     final = false;
                    // }
                }
            }
    ...
    jQuery_3_5_1(document).on('submit', '#modalReception .modal-1__form', function (e) {
        ...
        jQuery_3_5_1.ajax({
            ...
            error: function (jqXHR, exception) {
                ...
                jQuery_3_5_1('.modal-1 .more__text').removeAttr('disabled').removeClass('loading');
                console.log(jqXHR)
...
var clinic_mass = {
    ...
    function create_combox_metro(mass_metro_coord) {
        ...
        jQuery(".select-metro li").on('click', function () {
            /**/
            show_opik_under_map(jQuery_3_5_1(this).text(), clinic_mass, 'rayon')
            /**/
            myMap.setCenter(
                jQuery_3_5_1(this).attr("value").split(','),
                15
