...
jQuery_3_5_1('.jsPdfPutLinzy').on('click', function () {
    ...
    yandexSend(66929020, 'reachGoal', 'pdf_rekomendacii_kak_nadevat_i_snimat_linzy_misight_1_day');
});
jQuery_3_5_1('.jsPdfBrochureProgram').on('click', function () {
    console.log('нажал на PDF Brochure Program');
    yandexSend(66929020, 'reachGoal', 'pdf_znakomstvo_s_programmoy_yab_s_linzami_misight_1_day');
});
...
jQuery_3_5_1(document).ready(function(){
    ...
    const openModal = function(idOptika, cityOptika) {
        ...
        googleSend('send', 'event', 'optics_misight', 'modal_optics_open');
        // yandexSend(66929020, 'reachGoal', 'modal_optics_open');
    ...
    jQuery_3_5_1(document).on('click','.jsSignUp',function(event){
        ...
        googleSend('send', 'event', 'optics_misight', 'click_optics_info');
        yandexSend(66929020, 'reachGoal', 'click_optics_info');
    ...
    jQuery_3_5_1('#modalCheckBox1').on('change', function() {
        ...
        googleSend('send', 'event', 'optics_misight', 'modal_optics_chk_privacy');
        yandexSend(66929020, 'reachGoal', 'modal_optics_chk_privacy');
    });
    ...
    jQuery_3_5_1('#modalCheckBox1_2').on('change', function() {
        ...
        googleSend('send', 'event', 'optics_misight', 'modal_optics_chk_mailing');
        yandexSend(66929020, 'reachGoal', 'modal_optics_chk_mailing');
    });
        ...
        jQuery_3_5_1.ajax({
            ...
            success: function (result) {
                ...
                if (result.verification === true) {
                    ...
                    googleSend('send', 'event', 'optics_misight', 'modal_success_optics');
                    yandexSend(66929020, 'reachGoal', 'modal_success_optics');
                }
            },
    ...
    jQuery_3_5_1(document).on('submit', '.smsVerif', function (e) {
        googleSend('send', 'event', 'optics_misight', 'modal_optics_sms');
        yandexSend(66929020, 'reachGoal', 'modal_optics_sms');
        e.preventDefault();
        jQuery_3_5_1.ajax({
...
'54.711915, 55.992917': {
       ...
       time_weekend_sun: '11:00-18:00',
        ...
        street: 'ул. Менделеева, 116',
         doctor: 'Валиуллина Альфия Ринадовна'
    },
'54.743468, 56.025732': {
...
'54.751175, 56.000166': {
        Id_optika: 'a1e9634b-bd14-4b06-972f-efc0a6291fef',
        balloonContent: 'Оправа',
        time: '10:00-20:00',
        time_weekend: '10:00-20:00',
       time_weekend_sun: '10:00-20:00',
        phone: '+7 (347) 286 58 59',
        phone2: '',
        oblast: 'Башкортостан Республика',
        city: 'Уфа',
        rayon: '',
        street: 'пр-т Октября, 42',
         doctor: 'Аскарова Айгуль Фанисовна'
    },
'54.742730, 55.986099': {
        Id_optika: '3a6238d2-59c6-49d4-b3cc-795dd5ce7f64',
        balloonContent: 'Риа-медоптик',
        time: '09:00-19:00',
        time_weekend: '09:00-19:00',
       time_weekend_sun: 'выходной',
        phone: '+7 (347) 216 03 02',
        phone2: '',
        oblast: 'Башкортостан Республика',
        city: 'Уфа',
        rayon: '',
        street: 'ул. Бабушкина, 52',
         doctor: 'Хазиева Алсу Фидусовна, Даянова Лилия Ришадовна'
    },
'54.736436, 55.968959': {
        Id_optika: '8b515c16-86bd-4162-a337-a1bfc5353782',
        balloonContent: 'Риа-медоптик',
        time: '08:00-20:00',
        time_weekend: '08:30-18:00',
       time_weekend_sun: 'выходной',
        phone: '+7 (347) 216 03 02',
        phone2: '',
        oblast: 'Башкортостан Республика',
        city: 'Уфа',
        rayon: '',
        street: 'ул. 50-летия Октября, 18',
         doctor: 'Якупова Эльмира Галинуровна, Саяпова Гульназ Камиловна'
    },
'54.722295, 55.941336': {
...
'55.573973, 37.488943': {
        Id_optika: '0ffa3f7f-caca-40c4-9363-bc5c4d888889',
        balloonContent: 'Центр восстановления зрения для детей и взрослых Doc. Feelgood',
        time: '10:00-20:00',
        time_weekend: '10:00-18:00',
       time_weekend_sun: 'выходной',
        phone: '+7 (991) 314 33 41',
        phone2: '',
        oblast: 'Москва',
        city: 'Москва',
        rayon: 'Коммунарка',
        street: 'ул. Бачуринская, 19',
         doctor: 'Азербаев Тмерлан Эрколиевич, Агапова Элла Эдуардовна, Хашукоева Мадина Заудиновна'
    },
'55.868915, 37.664905': {
...
'55.728778, 37.610988': {
        ...
        time: '10:00-20:00',
        time_weekend: '-уточняйте по телефону',
       time_weekend_sun: '-уточняйте по телефону',
...
'55.739422, 37.587605': {
        Id_optika: 'a095d844-3cad-4ccd-ae74-3f9e17030466',
        balloonContent: 'Салон оптики Игоря Медведева',
        time: '09:00-20:00',
        time_weekend: '10:00-20:00',
       time_weekend_sun: '10:00-18:00',
        phone: '+7 (499) 766 46 43',
        phone2: '',
        oblast: 'Москва',
        city: 'Москва',
        rayon: 'м. Парк культуры',
        street: 'ул. Пречистенка, 40/2с2',
         doctor: 'Яна Полиенко'
    },
'55.734151, 37.618920': {
...
'58.004781, 56.257093': {
        Id_optika: '',
        balloonContent: 'Технологии зрения',
        time: '10:00-20:00',
        time_weekend: '10:00-20:00',
       time_weekend_sun: '10:00-20:00',
        phone: '+7 (342) 208 20 30',
        phone2: '',
        oblast: 'Пермский край',
        city: 'Пермь',
        rayon: '',
        street: 'ул. Революции, 24',
         doctor: 'Ольга Костарева, Наталья Шмырева, Елена Завалина'
    },
'58.006736, 56.230045': {
...
'53.241465, 50.211342': {
        Id_optika: '99fdf4fc-027b-467e-a43b-c5cc051d6d52',
        balloonContent: 'Доктор Линз',
        time: '10:00-20:00',
        time_weekend: '10:00-19:00',
       time_weekend_sun: '10:00-19:00',
        phone: '+7 (846) 200 58 01',
        phone2: '',
        oblast: 'Самарская область',
        city: 'Самара',
        rayon: '',
        street: 'ул. Ново-Вокзальная, 146',
         doctor: 'Шмаркунова Лариса Арсентьевна'
    },
'53.258820, 50.222472': {
        Id_optika: '0b8e51ce-def0-40e6-a258-4482dd13466b',
       ...
       time_weekend_sun: '10:00-18:00',
        ...
        street: 'ул. Молодежная, 10',
         doctor: 'Журков Александр Сергеевич, Власкин Сергей Иванович, Сайко Наталья'
    },
'53.507933, 49.415300': {
...
'59.951713, 30.290275': {
        ...
        time_weekend: '10:00-19:00',
       time_weekend_sun: '10:00-19:00',
        phone: '+7 (812) 607 12 20',
        phone2: '',
        oblast: 'Санкт-Петербург',
        city: 'Санкт-Петербург',
        rayon: 'м. Спортивная',
        street: 'пр-т Добролюбова, 20 к. 1',
         doctor: 'Пичугина Ксения Евгеньевна, Романенко Людмила Андреевна, Сероева Наталья Николаевна, Сугак Марина Евгеньевна, Казанцева Екатерина Игоревна'
    },
'59.943706, 30.359077': {
...
'56.842147, 60.620139': {
        Id_optika: 'd7aeb63f-227d-4465-b9e3-21dd1f3fab2c',
        balloonContent: 'Очкофф',
        time: '10:00-20:00',
        time_weekend: '10:00-20:00',
       time_weekend_sun: '11:00-19:00',
        phone: '+7 (343) 350 23 79',
        phone2: '',
        oblast: 'Свердловская область',
        city: 'Екатеринбург',
        rayon: '',
        street: 'ул. Ленина, 69/4',
         doctor: 'Трошкова Ирина'
    },
'56.806870, 60.597564': {
...
'56.800947, 60.613303': {
        Id_optika: 'e0fad380-c17b-46f5-8817-818ba6058615',
        balloonContent: 'Очкофф',
        time: '10:00-20:00',
        time_weekend: '10:00-20:00',
       time_weekend_sun: '11:00-19:00',
        phone: '+7 (343) 266 14 02',
        phone2: '',
        oblast: 'Свердловская область',
        city: 'Екатеринбург',
        rayon: 'м. Чкаловская',
        street: 'ул. 8 марта, 179а',
         doctor: 'Лебедева Наталья'
    },
'43.018447, 44.658307': {
...
'56.877110, 35.835917': {
        Id_optika: '7bcfaf89-33c8-4c0f-80ce-cc2f794a77db',
        balloonContent: 'Офтальмолоджи',
        time: '09:00-18:00',
        time_weekend: '09:00-18:00',
       time_weekend_sun: 'выходной',
        phone: '+7 (991) 352 17 00',
        phone2: '',
        oblast: 'Тверская область',
        city: 'Тверь',
        rayon: '',
        street: 'ул. Хромова, 4',
         doctor: 'Рябцева Марина Анатольевна, Горбачева Ольга Викторовна, Горюнов Дмитрий Сергеевич'
    },
'56.510288, 84.984489': {
...
'56.864384, 53.179771': {
        Id_optika: '7c0bd984-ea20-4023-b9a5-b23ff7133f44',
